...
class PracticeQuestion: AppBaseModel {
...
class PracticeMainDataModel : AppBaseModel {

    var practiceQuestionsModelArray : [PracticeQuestion]?
    
    // MARK: Lifecycle
    required init?(json: JSON){
        self.practiceQuestionsModelArray = "questions" <~~ json
